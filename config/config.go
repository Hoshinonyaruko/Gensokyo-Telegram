...
func GetBotToken() string {
	...
	if instance == nil {
		mylog.Println("Warning: instance is nil when trying to get BotToken value.")
		return ""
	}
	return instance.Settings.BotToken
}
...
func GetCustomCert() bool {
	...
	if instance == nil {
		mylog.Println("Warning: instance is nil when trying to CustomCert value.")
		return false
	}
	return instance.Settings.CustomCert
}
...
func GetUseNgrok() bool {
	...
	if instance == nil {
		mylog.Println("Warning: instance is nil when trying to UseNgrok value.")
		return false
	}
	return instance.Settings.UseNgrok
}
...
func GetHttpGetMsg() bool {
	...
	if instance == nil {
		mylog.Println("Warning: instance is nil when trying to HttpGetMsg value.")
		return false
	}
	return instance.Settings.HttpGetMsg
}
...
func GetMsgTimeOut() int {
	...
	if instance == nil {
		mylog.Println("Warning: instance is nil when trying to GetMsgTimeOut value.")
		return 3
	}
	return instance.Settings.GetMsgTimeOut
}
...
func GetNgrokKey() string {
	...
	if instance == nil {
		mylog.Println("Warning: instance is nil when trying to get NgrokKey.")
		return ""
	}
	return instance.Settings.NgrokKey
}
...
func GetHighWay() bool {
	...
	if instance == nil {
		mylog.Println("Warning: instance is nil when trying to HighWay value.")
		return false
	}
	return instance.Settings.HighWay
}
...
func GetSendDirectResponse() bool {
	...
	if instance == nil {
		mylog.Println("Warning: instance is nil when trying to SendDirectResponse value.")
		return false
	}
	return instance.Settings.SendDirectResponse
}
