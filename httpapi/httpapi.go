...
// 			handleSendGroupMessage(c)
// 			return
// 		}
// 		// if c.Request.URL.Path == "/send_private_msg" {
// 		// 	handleSendPrivateMessage(c)
// 		// 	return
// 		// }
...
// func handleSendGroupMessage(c *gin.Context) {
// 	var retmsg string
// 	var req struct {
...
// 	}
// 	// 调用处理函数
// 	retmsg, err := handlers.HandleSendGroupMsg(client, message)
// 	if err != nil {
...
// func handleSendGuildChannelMessage(c *gin.Context) {
// 	var retmsg string
// 	var req struct {
